...
<div class="container1" >
    <header>
        ...
        <nav>
            ...
            <li><a href="tentang.php" style="text-decoration:underline">Tentang Kami</a></li>
            <li><a href="alami.php">Perkawinan Alami</a></li>
            <li><a href="buatan.php">Perkawinan Buatan</a></li>
            <li><a href="tentangEng.php"><img src="English.svg" alt="Logo" width="30" height="30"></a></li>
